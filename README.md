...
Welcome to my collection of tools used during Capture The Flag (CTF) competitions & Pentesting. Over time, I’ve gathered and refined a set of utilities, scripts, and frameworks that help tackle a wide range of CTF challenges, including binary exploitation, cryptography, web vulnerabilities, reverse engineering, forensics, OSINT, and more.
